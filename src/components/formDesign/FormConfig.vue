	...
	<div class="form-config-container">
		<el-form label-position="left"  label-width="130px" size="small">
			...
			<el-form-item label="多分组转标签">
				<el-switch v-model="data.tabs" active-color="#6087FD"></el-switch>
			</el-form-item>
        ...
        <el-select v-model="data.tabsType">
          ...
          <el-option label="卡片2"
			...
			<el-form-item label="显示按钮">
				<el-switch v-model="data.menuBtn" active-color="#6087FD"></el-switch>
			</el-form-item>
        ...
        <el-select v-model="data.menuPostion"
          ...
          <el-option label="居右"
			...
			<el-form-item label="显示提交按钮" v-if="data.menuBtn">
				<el-switch v-model="data.submitBtn" active-color="#6087FD"></el-switch>
			</el-form-item>
        ...
        <el-select v-model="data.submitSize"
          ...
          <el-option label="超小"
			...
			<el-form-item label="显示清空按钮" v-if="data.menuBtn">
				<el-switch v-model="data.emptyBtn" active-color="#6087FD"></el-switch>
			</el-form-item>
